...
P__tilde__YFle = Particle(pdg_code = 9000008,
                          name = '~YFle',
                          antiname = '~YFle~',
                          spin = 2,
                          color = 1,
...
P__tilde__YFle__tilde__ = P__tilde__YFle.anti()

P__tilde__YFlv = Particle(pdg_code = 9000009,
                          name = '~YFlv',
                          antiname = '~YFlv~',
                          spin = 2,
                          color = 1,
...
P__tilde__YFlv__tilde__ = P__tilde__YFlv.anti()
