...
*Notice that the matching of models with heavy flavored particles is supported in `Matchete` only from `v0.3.0` onwards, as is the updated model file format used here. However, the WCxf output (discussed below) requires [`v0.3.2`](https://gitlab.com/matchete/matchete/-/tags/v0.3.2).
