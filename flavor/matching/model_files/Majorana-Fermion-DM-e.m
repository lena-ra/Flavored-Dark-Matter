...
(* ::Title:: *)
(*Flavored Majorana fermion Dark Matter coupled to the right-handed charged lepton singlet*)
...
Module[{DMLag,p,r,i,a},
	DMLag = FreeLag[\[Chi],\[Phi]] + 
		\[Lambda]H\[Phi]1[] Bar[H[i]]*H[i]*Bar[\[Phi][]]*\[Phi][] + 
		PlusHc[\[Lambda]\[Psi]\[Chi][p,r]*Bar[e[p]]**\[Chi][r]*\[Phi][]];
